...
export const ui = {
  en: {
    ...
    "form.name": "Name",
    "form.name.placeholder": "Jane Runner",
    "form.email": "Email",
    "form.email.placeholder": "you@example.com",
    "form.role": "I am",
    "form.role.runner": "A runner",
    "form.role.coach": "An independent coach",
    "form.role.company": "A company / club",
    "form.role.other": "Something else",
    "form.organization": "Organization (optional)",
    "form.organization.placeholder": "Your club or company name",
    "form.message": "Message",
    "form.message.placeholder": "What can we help you with?",
    "form.submit": "Send message",
    "form.submit.sending": "Sending…",
    "form.error.name": "Please enter your name (max 200 characters).",
  ...
  fr: {
    ...
    "footer.termsOfUse": "Conditions générales d'utilisation",

    "carousel.prev": "Précédent",
    "carousel.next": "Suivant",

    "watch.comingSoon": "Bientôt disponible",
    ...
    "form.role": "Je suis",
    "form.role.runner": "Un coureur",
    "form.role.coach": "Un coach indépendant",
    "form.role.company": "Une entreprise / un club",
    "form.role.other": "Autre chose",
    "form.organization": "Organisation (optionnel)",
    "form.organization.placeholder": "Nom de votre club ou entreprise",
    "form.message": "Message",
  ...
  nl: {
    ...
    "watch.comingSoon": "Binnenkort beschikbaar",
    ...
    "platform.watch": "Horloge",

    "theme.toggle": "Thema wisselen",

    "form.name": "Naam",
    "form.name.placeholder": "Anne Loper",
    "form.email": "E-mail",
    "form.email.placeholder": "jij@voorbeeld.com",
    "form.role": "Ik ben",
    "form.role.runner": "Een loper",
    "form.role.coach": "Een zelfstandige coach",
    "form.role.company": "Een bedrijf / club",
    "form.role.other": "Iets anders",
    "form.organization": "Organisatie (optioneel)",
    "form.organization.placeholder": "Naam van je club of bedrijf",
    "form.message": "Bericht",
    "form.message.placeholder": "Waarmee kunnen we je helpen?",
    "form.submit": "Bericht verzenden",
    "form.submit.sending": "Versturen…",
